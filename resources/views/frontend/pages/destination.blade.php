...
<div class="nhp-banner-c">
    <img src="{{asset($key[48]->val)}}" alt="Scholarship Offers">
    <button class="edit button-1 top_left" id="edit_button" onclick="getEditModal(48,'file','1920 X 452')"  style="z-index: 99">
    ...
    <div class="container"> 
            <div class="col-sm-12">
                <div class="text-center">
                    <h3>Our Partner Institution in {{$data->country}}</h3>
                </div>
            </div>
        </div>
