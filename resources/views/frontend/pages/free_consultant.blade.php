        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12"> 
                <div class="fc-content position-relative">
                    ...
                    <iframe src="{{$key[17]->val}}" width="100%" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
