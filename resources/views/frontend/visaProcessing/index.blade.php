...
<div class="nhp-banner-c">
    <img src="{{asset($key[47]->val)}}" alt="Scholarship Offers">
    <button class="edit button-1 top_left" id="edit_button" onclick="getEditModal(47,'file','1920 X 452')"  style="z-index: 99">
